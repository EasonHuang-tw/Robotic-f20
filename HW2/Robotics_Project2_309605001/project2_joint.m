...
thetaB = [67.948868   -2.529005   -44.425928   105.455397   74.075319   134.780234]';
thetaC = [124.599928   -28.219289   -127.988642   -0.000000   -23.792068   -55.400072]';
...
text(A(1,4)+0.05, A(2,4)-0.05, A(3,4)-0.01, 'A(20,30,20)')
scatter3(B(1,4), B(2,4), B(3,4), [], 'k', 'filled')
text(B(1,4)-0.05, B(2,4)-0.1, B(3,4)-0.05, 'B(-10,15,30)')
scatter3(C(1,4), C(2,4), C(3,4), [], 'k', 'filled')
text(C(1,4), C(2,4)-0.05, C(3,4)+0.1, 'C(-25,10,-20)')
...
xlabel('x(cm)'), ylabel('ycm)'), zlabel('z(cm)')
title('3D path of Joint Motion')
axis equal
set(gca,'XGrid','on'), set(gca,'YGrid','on'), set(gca,'ZGrid','on');
